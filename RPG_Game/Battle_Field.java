...
public class Battle_Field extends JFrame {
	boolean ishit = false;
	int ran;
	int first_heal = 0;
	String HP;
	...
	public void Rand_Monst()
	{
		...
		{
			case 0:
				Monster.Slime slime = Mons.new Slime();
				getStat_M();
				break;
			case 1:
				Monster.Orc orc = Mons.new Orc();
				getStat_M();
				break;
			case 2:
				Monster.Skeleton skeleton = Mons.new Skeleton();
				getStat_M();
				break;	
			case 3:
				Monster.Zombie zombie = Mons.new Zombie();
				getStat_M();
				break;
		}
	}
	...
	public Battle_Field()
	{
		...
		lb3.setFont(font2);
		lb3.setBounds(150, 150, 400, 30);
		lb3.setText(Name);
		
		JLabel lb4 = new JLabel("HP : ");
		lb4.setFont(font2);
		lb4.setBounds(70, 175, 100, 30);
		
		JLabel lb5 = new JLabel();
		lb5.setFont(font2);
		lb5.setBounds(115, 175, 400, 30);
		lb5.setText(HP);

		JLabel lb6 = new JLabel("ATT : ");
		lb6.setFont(font2);
		lb6.setBounds(70, 200, 100, 30);
		
		JLabel lb7 = new JLabel();
		lb7.setFont(font2);
		lb7.setBounds(130, 200, 400, 30);
		lb7.setText(ATT);
		
		JLabel lb8 = new JLabel("DEF : ");
		lb8.setFont(font2);
		lb8.setBounds(70, 225, 100, 30);
		
		JLabel lb9 = new JLabel();
		lb9.setFont(font2);
		lb9.setBounds(130, 225, 400, 30);
		lb9.setText(DEF);
		...
		lb12.setFont(font2);
		lb12.setBounds(70, 250, 100, 30);
		
		JLabel lb13 = new JLabel();
		lb13.setFont(font2);
		lb13.setBounds(130, 250, 400, 30);
		lb13.setText(ACC);
		
		JLabel lb14 = new JLabel("EXP : ");
		lb14.setFont(font2);
		lb14.setBounds(70, 275, 100, 30);
		
		JLabel lb15 = new JLabel();
		lb15.setFont(font2);
		lb15.setBounds(130, 275, 400, 30);
		lb15.setText(EXP);
		
		JLabel lb25 = new JLabel("LEVEL : ");
		lb25.setFont(font2);
		lb25.setBounds(70, 300, 100, 30);
		
		JLabel lb26 = new JLabel();
		lb26.setFont(font2);
		lb26.setBounds(155, 300, 400, 30);
		lb26.setText(LEV);
		...
		JButton b3 = new JButton("+0~30HP(H)");
